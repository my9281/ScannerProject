...
public sealed class OperationsPageController : ControllerBase
{
    ...
    public OperationsPageController(IOperationsPageView view, MaUIScanner.Windows.IWindow window, ChecklistDataCache baseData) { _view = view; _window = window;  _baseData = baseData;  RefreshBase();  }
