...
public sealed class MainPageController : ControllerBase
{
    ...
    public MainPageController(IMainPageView view, MaUIScanner.Windows.IWindow window, MainViewModel viewModel) { _view = view; _window = window;  _viewModel = viewModel; _view.BindingContext = viewModel; }
