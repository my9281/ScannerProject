...
public sealed class LabelPrinter : ILabelPrinter
{
    ...
    private static void EnsureWindowsPrintFonts()
    {
        ...
        lock (FontSync)
        {
            ...
            string imingPath = ExtractFont("MaUIScanner.PrintFonts.IMing.ttf", Path.Combine(fontDirectory, "IMing.ttf"));
            string shouJinPath = ExtractFont("MaUIScanner.PrintFonts.OpenSans-Regular.ttf", Path.Combine(fontDirectory, "OpenSans-Regular.ttf"));
