...
public sealed class MainPageController : ControllerBase
{
    ...
    public MainPageController(IMainPageView view, Scan.MaUI.Windows.IWindow window, MainViewModel viewModel) { _view = view; _window = window;  _viewModel = viewModel; _view.BindingContext = viewModel; }
