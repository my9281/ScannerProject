...
public sealed class LoginPageController : ControllerBase
{
    ...
    public LoginPageController(ILoginPageView view, Scan.MaUI.Windows.IWindow window, AuthService auth, SessionStore sessions) { _view = view; _window = window;   _auth = auth; _sessions = sessions;  }
